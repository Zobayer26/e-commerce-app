...
import ProductImage from "@/components/ProductStyle/ProductImage";
...
const UpdateProduct:React.FC<Iparams> = ({ productId,product }) => {
    ...
    const onSubmitHandle: SubmitHandler<FieldValues> = async (data) => {
        ...
        axios.put(`/api/product/${productId}`,productData).then(() => {
